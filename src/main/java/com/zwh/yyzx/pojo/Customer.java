...
@ApiModel(value = "Customer对象", description = "Customer实体类")
public class Customer implements Serializable {
    ...
    @ApiModelProperty(value = "逻辑删除标记（0：显示：1隐截）")
    ...
    @ApiModelProperty(value = "性别：男1：女")
    ...
    @ApiModelProperty(value = "美联系统健康管家（护工）")
