 ...
 */
 ...
 gc.setOutputDir("E:\\code\\JetBrain\\java\\yyzx\\src\\main\\java");
 gc.setAuthor("zwh");// 设置作者名字
 ...
 dsc.setPassword("20030614");
 mpg.setDataSource(dsc);
 // 包配置
 PackageConfig pc = new PackageConfig();
// pc.setModuleName(scanner("模块名"));
 // ⼆、模块配置
 pc.setParent("com.zwh.yyzx")
 .setEntity("com/zwh/yyzx/pojo")
 .setMapper("mapper")
 .setService("service")
 ...
 return   "E:\\code\\JetBrain\\java\\yyzx\\src\\main\\resources\\mapper" + pc.getModuleName()
